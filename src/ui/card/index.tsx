    ...
    return (
        <Card className='dark:bg-[#111827] relative max-w-full sm:max-w-md w-full'>
            <CardBody className='p-0 overflow-hidden'>
                ...
                <NextImage as={Image} src={`https://picsum.photos/${800 + index}`} isBlurred radius='none' alt='rasm' className='w-full h-auto object-cover aspect-[5/3] ' width={580} height={448} />
